...
export default function FAQ() {
  const faqContent = [
    ...
    { id: 6, question: "Do you handle cleanup and apple solids disposal?", answer: "Yes, we sanitize our equipment before and after use. Apple remnants will be disposed of by Olsen’s Hometown Cider unless requested for composting by customer." },
  ]
